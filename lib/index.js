...
function assertValue (name, value) {
  ...
  if (found) {
    throw new TypeError(
      'Invalid character ' + JSON.stringify(found[0]) + ' in Content-Security-Policy directive "' +
      name + '": a directive value may not contain control characters, ";", "," or non-ASCII characters.'
    );
  }
}
